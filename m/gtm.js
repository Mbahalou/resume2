...
"resource": {
  ...
  "tags":[{
      ...
      "once_per_event":true,
      "vtp_overrideGaSettings":false,
      "vtp_optimizeContainerId":"GTM-TQDR65W",
      "vtp_gaSettings":["macro",1],
      "tag_id":69
    }],
  "predicates":[{
  ...
  "rules":[
    [["if",0],["add",0,20,43,44,21,22,23,25,26,27,28,29,30,31,32,34,35,36,37,38,39,40,41,42]],
    [["if",1,2],["add",1]],
    [["if",2,3],["add",2]],
    [["if",2,4],["add",3]],
    [["if",5,6,7],["add",4]],
...
function Tc(a){if(a instanceof ya||a instanceof lb||a instanceof k||a instanceof pb||a instanceof tb||null===a||void 0===a||"string"===typeof a||"number"===typeof a||"boolean"===typeof a)return a};var td;
...
"set",t);f(g+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(g+"require","render");a||(a=!0,S(q,function(){return fk().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var u=U("dataLayer"),v=u&&u.hide;v&&(v.end||!0===v["GTM-TDRQP6V"])&&(v[b.vtp_optimizeContainerId]=!0)}else N(b.vtp_gtmOnFailure)})}();
